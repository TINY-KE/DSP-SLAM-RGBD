...
Thirdparty_DIR="/home/robotlab/thirdparty/for_dspslam"
...
if [[ $* == *--build-dependencies* ]]; then
  ...
  cd build
  cmake -DOpenCV_DIR="/home/robotlab/thirdparty/for_dspslam/opencv" ..
  make -j8
  cd ../../..
...
if [[ $* == *--build-dependencies-author* ]]; then
...
Thirdparty_DIR = "/home/robotlab/thirdparty"

cmake \
  -DOpenCV_DIR="$(Thirdparty_DIR)/opencv/build" \
  -DEigen3_DIR="$(Thirdparty_DIR)/eigen/install/share/eigen3/cmake" \
  -DPangolin_DIR="$(Thirdparty_DIR)/Pangolin/build" \
