...
void VisualizeGradientMat(Measurements& mms, Objects& objs, const Matrix3d& calib, int rows, int cols)
{
    ...
    EllipsoidSLAM::Object& obj = objs[0];
...
void VisualizeExperienmentResult(EllipsoidSLAM::System* pSLAM, std::vector<FrameData>& frameDatas,  Matrix3d& calib, int rows, int cols,
