...
namespace ORB_SLAM2
{
    ...
    public:
        ...
        void GetNewObservations_onyforStereo();
        void CreateNewMapObjects_foronlyStereo();
        void MapObjectCulling();
        void CreateNewObjectsFromDetections_onlyformono();
        void ProcessDetectedObjects_onlyformono();
